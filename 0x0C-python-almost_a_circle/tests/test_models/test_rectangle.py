#!/usr/bin/python3
"""This module contains unittests for rectangle.py.
"""
import io
import sys
import unittest
...
class TestRectangle_instantiation(unittest.TestCase):
    """Unittests for the instantiation of Rectangle class."""
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for the initialization of width attribute."""
...
class TestRectangle_height(unittest.TestCase):
    """Unittests for the initialization of height attribute."""
...
class TestRectangle_x(unittest.TestCase):
    """Unittests for the initialization of x attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """Unittests for the initialization of y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests for the order of attribute initialization."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for the __str__ and display methods."""

    @staticmethod
    def capture_stdout(rect, method):
        """Captures and returns text printed to stdout.
        Args:
            rect: The Rectangle object to print to stdout.
            method: The method to be executed on rect.
        Returns:
            The text printed to stdout by executing the method on rect.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_args(unittest.TestCase):
    """Unittests for the update args method."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittests for the update kwargs method."""
