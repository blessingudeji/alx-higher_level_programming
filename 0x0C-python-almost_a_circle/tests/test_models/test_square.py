#!/usr/bin/python3
"""This module contains unittests for square.py.
"""
import io
import sys
import unittest
...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests for the instantiation of the Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Unittests for the size initialization of the Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def capture_stdout(sq, method):
        ...
        Args:
            sq: The Square object to print to stdout.
            method: The method to be executed on sq object.
        Returns:
            The text printed to stdout by executing the method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
